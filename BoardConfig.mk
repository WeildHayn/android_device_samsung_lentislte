...
BOARD_MKBOOTIMG_ARGS := --ramdisk_offset 0x02600000 --tags_offset 0x02400000 --dt device/samsung/lentislte/prebuilt/dtb
...
TARGET_PREBUILT_KERNEL := device/samsung/lentislte/prebuilt/kernel
...
TARGET_RECOVERY_FSTAB := device/samsung/lentislte/recovery/etc/recovery.fstab
...
# LZMA ramdisk
# BOARD_CUSTOM_BOOTIMG_MK := device/samsung/lentislte/custombootimg.mk # Does kernel support LZMA?
